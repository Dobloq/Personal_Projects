...
public class MatrizImpl implements Matriz {
	...
	public void setMatrizIdentidad(Matriz m) {
		this.matrizIdentidad = (MatrizIdentidad) m;
	}
	...
	public MatrizImpl() {
		...
		MatrizIdentidad matrizIdentidad = new MatrizIdentidad(this);
		this.matrizIdentidad = matrizIdentidad;
	}

	// Constructor para crear una matriz de un tamaño especifico
	public MatrizImpl(double filas, double columnas) {
		this.filas = filas;
	...
	public static void multiplicarMatriz() {
		...
		MatrizImpl m1 = new MatrizImpl();
		System.out.println("Matriz 2");
		MatrizImpl m2 = new MatrizImpl();
		if (m1.getColumnas() != m2.getFilas()) {
			...
			MatrizImpl m = new MatrizImpl(m1.getFilas(), m2.getColumnas());
			/*
	...
	public static void sumarMatrices() {
		...
		if (m1.getFilas() != m2.getFilas() || m1.getColumnas() != m2.getColumnas()) {
			...
			MatrizImpl m = new MatrizImpl(m1.getFilas(), m1.getColumnas());
